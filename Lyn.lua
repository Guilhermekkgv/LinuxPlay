...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local originalColor = Color3.fromRGB(15, 15, 20)
            local hoverColor = Color3.fromRGB(20, 20, 25)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 20, 0.5, -7), BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                    else
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(30, 30, 35)}):Play()
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        ...
                        local OptBtn = Linux.Instance("TextButton", {
                            Parent = OptionsHolder,
                            BackgroundColor3 = isSelected and Color3.fromRGB(25, 25, 30) or Color3.fromRGB(20, 20, 25),
                            BorderSizePixel = 0,
                        ...
                        OptBtn.MouseEnter:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(22, 22, 27)}):Play()
                            end
                        end)
                        
                        OptBtn.MouseLeave:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 20, 25)}):Play()
                            end
                        end)
        ...
        function TabElements.Colorpicker(config)
            ...
            local function CreateColorpickerPopup()
                ...
                ApplyButton.MouseEnter:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(35, 35, 40)}):Play()
                end)
                
                ApplyButton.MouseLeave:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(30, 30, 35)}):Play()
                end)
