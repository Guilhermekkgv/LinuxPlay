...
Linux.Themes = {
    Default = {
        MainBackground = Color3.fromRGB(14, 14, 19),
        SecondaryBackground = Color3.fromRGB(18, 18, 23),
        ElementBackground = Color3.fromRGB(25, 25, 30),
        ElementBackgroundHover = Color3.fromRGB(35, 35, 40),
        ElementBackgroundClick = Color3.fromRGB(45, 45, 50),
        TextPrimary = Color3.fromRGB(230, 230, 240),
        TextSecondary = Color3.fromRGB(200, 200, 210),
        TextTertiary = Color3.fromRGB(150, 150, 155),
    ...
    Light = {
        ...
        ElementBackgroundClick = Color3.fromRGB(200, 200, 205),
        TextPrimary = Color3.fromRGB(30, 30, 35),
        TextSecondary = Color3.fromRGB(50, 50, 55),
        TextTertiary = Color3.fromRGB(80, 80, 85),
        Accent = Color3.fromRGB(50, 50, 55),
        Border = Color3.fromRGB(180, 180, 190),
        SliderBackground = Color3.fromRGB(180, 180, 190),
        ToggleBackground = Color3.fromRGB(180, 180, 190),
        InputBackground = Color3.fromRGB(210, 210, 215),
        NotificationBackground = Color3.fromRGB(230, 230, 235)
    },
    Midnight = {
        MainBackground = Color3.fromRGB(10, 10, 18),
        ...
        ElementBackgroundClick = Color3.fromRGB(30, 30, 55),
        TextPrimary = Color3.fromRGB(220, 220, 255),
        TextSecondary = Color3.fromRGB(180, 180, 230),
        TextTertiary = Color3.fromRGB(140, 140, 200),
        Accent = Color3.fromRGB(130, 130, 255),
        Border = Color3.fromRGB(40, 40, 80),
        SliderBackground = Color3.fromRGB(40, 40, 80),
        ToggleBackground = Color3.fromRGB(40, 40, 80),
    ...
    Ocean = {
        ...
        SecondaryBackground = Color3.fromRGB(15, 25, 35),
        ElementBackground = Color3.fromRGB(20, 30, 45),
        ElementBackgroundHover = Color3.fromRGB(25, 40, 55),
        ElementBackgroundClick = Color3.fromRGB(30, 50, 65),
        TextPrimary = Color3.fromRGB(220, 230, 255),
        TextSecondary = Color3.fromRGB(180, 200, 230),
        TextTertiary = Color3.fromRGB(140, 160, 200),
        Accent = Color3.fromRGB(100, 180, 255),
        Border = Color3.fromRGB(30, 60, 90),
        SliderBackground = Color3.fromRGB(30, 60, 90),
        ToggleBackground = Color3.fromRGB(30, 60, 90),
        InputBackground = Color3.fromRGB(15, 25, 40),
        NotificationBackground = Color3.fromRGB(15, 25, 40)
    },
    Sunset = {
        MainBackground = Color3.fromRGB(25, 15, 25),
        SecondaryBackground = Color3.fromRGB(35, 20, 30),
        ElementBackground = Color3.fromRGB(45, 25, 40),
        ElementBackgroundHover = Color3.fromRGB(55, 30, 50),
        ElementBackgroundClick = Color3.fromRGB(65, 35, 60),
        TextPrimary = Color3.fromRGB(255, 230, 240),
        TextSecondary = Color3.fromRGB(230, 200, 210),
        TextTertiary = Color3.fromRGB(200, 160, 180),
        Accent = Color3.fromRGB(255, 120, 170),
        Border = Color3.fromRGB(90, 50, 70),
        SliderBackground = Color3.fromRGB(90, 50, 70),
        ToggleBackground = Color3.fromRGB(90, 50, 70),
        InputBackground = Color3.fromRGB(40, 20, 35),
        NotificationBackground = Color3.fromRGB(40, 20, 35)
    }
}
...
function Linux:SafeCallback(Function, ...)
    ...
    if not Success then
        ...
        local FormattedError = ErrorMsg
        if type(ErrorMsg) == "string" then
            local ScriptName = "Linux UI"
            local LineNumber = ErrorMsg:match(":(%d+):")
            local ErrorDescription = ErrorMsg:match(":%d+:%s*(.*)")
            
            if LineNumber and ErrorDescription then
                FormattedError = ScriptName .. " (Line " .. LineNumber .. "): " .. ErrorDescription
            end
        end
...
function Linux:Notify(config)
    local theme = self.CurrentTheme or self.Themes.Default
    ...
    local hasIcon = config.Icon and config.EnableIcon ~= false
    local contentPadding = hasIcon and 40 or 5

    if hasIcon then
        local IconFrame = Linux.Instance("ImageLabel", {
            Parent = Notification,
    ...
    if config.IsError then
        local CopyButton = Linux.Instance("ImageButton", {
            Parent = Notification,
            BackgroundTransparency = 1,
        ...
        CopyButton.MouseEnter:Connect(function()
            TweenService:Create(CopyButton, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(220, 220, 230)}):Play()
        end)
        
        CopyButton.MouseLeave:Connect(function()
            TweenService:Create(CopyButton, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(180, 180, 190)}):Play()
        end)
        
        CopyButton.MouseButton1Click:Connect(function()
            if setclipboard then
                setclipboard(config.RawError or config.Content)
                
                local OriginalImage = CopyButton.Image
                local OriginalColor = CopyButton.ImageColor3
                
                CopyButton.Image = "rbxassetid://10747384537"
                CopyButton.ImageColor3 = Color3.fromRGB(50, 200, 100)
                
                task.delay(1, function()
                    CopyButton.Image = OriginalImage
                    CopyButton.ImageColor3 = OriginalColor
                end)
            end
        end)
    end
    ...
    Linux.Instance("TextLabel", {
        Parent = Notification,
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -contentPadding - 5, 0, 20),
        Position = UDim2.new(0, contentPadding, 0, 5),
    ...
    Linux.Instance("TextLabel", {
        Parent = Notification,
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -contentPadding - 5 - (config.IsError and 26 or 0), 0, 20),
        Position = UDim2.new(0, contentPadding, 0, 25),
        Font = Enum.Font.GothamSemibold,
    ...
    if config.SubContent then
        Linux.Instance("TextLabel", {
            ...
            BackgroundTransparency = 1,
            Size = UDim2.new(1, -contentPadding - 5, 0, 20),
            Position = UDim2.new(0, contentPadding, 0, 45),
            Font = Enum.Font.GothamSemibold,
...
function Linux.Create(config)
    ...
    Linux.CurrentTheme = Linux.Themes[themeName] or Linux.Themes.Default
    local theme = Linux.CurrentTheme
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local originalColor = theme.ElementBackground
            local hoverColor = theme.ElementBackgroundHover
            local clickColor = theme.ElementBackgroundClick
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = theme.Accent}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 20, 0.5, -7), BackgroundColor3 = theme.TextPrimary}):Play()
                    else
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = theme.ToggleBackground}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 2, 0.5, -7), BackgroundColor3 = theme.TextSecondary}):Play()
                    end
                end
        ...
        function TabElements.Dropdown(config)
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        ...
                        local OptBtn = Linux.Instance("TextButton", {
                            Parent = OptionsHolder,
                            BackgroundColor3 = isSelected and theme.ElementBackgroundClick or theme.ElementBackgroundHover,
                            BorderColor3 = theme.Border,
                            BorderSizePixel = 0,
                        ...
                        OptBtn.MouseEnter:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = theme.ElementBackgroundClick}):Play()
                            end
                        end)
                        
                        OptBtn.MouseLeave:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = theme.ElementBackgroundHover}):Play()
                            end
                        end)
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            if IsMulti then
                                ...
                                if index then
                                    ...
                                    OptBtn.BackgroundColor3 = theme.ElementBackgroundHover
                                else
                                    table.insert(SelectedValues, opt)
                                    OptBtn.TextColor3 = theme.TextPrimary
                                    OptBtn.BackgroundColor3 = theme.ElementBackgroundClick
                                end
                                UpdateSelectedText()
                                    ...
                                    for _, btn in pairs(OptionsHolder:GetChildren()) do
                                        if btn:IsA("TextButton") then
                                            if btn.Text == tostring(opt) then
                                                ...
                                                btn.BackgroundColor3 = theme.ElementBackgroundClick
                                            else
                                                btn.TextColor3 = theme.TextSecondary
                                                btn.BackgroundColor3 = theme.ElementBackgroundHover
                                            end
                                        end
                                    end
            ...
            local function StartAutoUpdate(updateCallback, interval)
                ...
                updateConnection = RunService.Heartbeat:Connect(function()
                    ...
                    if isAutoUpdating and updateCallback then
                        local success, newOptions = pcall(updateCallback)
                        if success and typeof(newOptions) == "table" then
                            local currentValue = IsMulti and SelectedValues or SelectedValue
                            SetOptions(newOptions)
                            
                            if IsMulti and typeof(currentValue) == "table" then
                            ...
                            elseif table.find(newOptions, currentValue) then
            ...
            return {
                ...
                IsAutoUpdating = function() return isAutoUpdating end
            }
        end
        ...
        function TabElements.Slider(config)
            ...
            Linux.Instance("UIGradient", {
                ...
                Color = ColorSequence.new({
                    ...
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(theme.Accent.R * 0.8, theme.Accent.G * 0.8, theme.Accent.B * 0.8))
                }),
                Rotation = 90
            })
        ...
        function TabElements.Colorpicker(config)
            ...
            local function UpdateColorFromHSV(updateInRealTime)
                ...
                if ColorpickerPopup then
                    ...
                    local hexDisplay = ColorpickerPopup:FindFirstChild("HexDisplay")
                    if hexDisplay then
                        local r, g, b = math.floor(currentColor.R * 255 + 0.5), math.floor(currentColor.G * 255 + 0.5), math.floor(currentColor.B * 255 + 0.5)
                        hexDisplay.Text = string.format("#%02X%02X%02X", r, g, b)
                    end
                end
                
                if updateInRealTime or not isPicking then
            ...
            local function CreateColorpickerPopup()
                ...
                local ColorPreviewBig = Linux.Instance("Frame", {
                    Parent = ColorpickerPopup,
                    BackgroundColor3 = currentColor,
                ...
                local HexDisplay = Linux.Instance("TextLabel", {
                    Parent = ColorpickerPopup,
                    BackgroundColor3 = theme.InputBackground,
                    Size = UDim2.new(0, 100, 0, 24),
                    Position = UDim2.new(0, 70, 0, 183),
                    Font = Enum.Font.Code,
                    Text = "#FFFFFF",
                    TextColor3 = theme.TextPrimary,
                    TextSize = 14,
                ...
                local ApplyButton = Linux.Instance("TextButton", {
                    Parent = ColorpickerPopup,
                    BackgroundColor3 = theme.ElementBackground,
                ...
                HueBar.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        currentHue = 1 - y
                        hueMarker.Position = UDim2.new(-0.1, 0, y, 0)
                        UpdateColorFromHSV(true)
                    end
                end)
                ...
                ApplyButton.MouseEnter:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = theme.ElementBackgroundHover}):Play()
                end)
                
                ApplyButton.MouseLeave:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = theme.ElementBackground}):Play()
                end)
                ...
                hueMarker.Position = UDim2.new(-0.1, 0, 1 - h, 0)
    ...
    if config.ConfigSave ~= false then
        ...
        SettingsTab.Section({Name = "Theme"})
        
        local themeOptions = {}
        for themeName, _ in pairs(Linux.Themes) do
        ...
        SettingsTab.Dropdown({
            ...
            Default = themeName,
            Callback = function(selected)
                Linux.CurrentTheme = Linux.Themes[selected]
                Linux:Notify({
                    Title = "Theme Changed",
                    Content = "The UI theme has been changed to " .. selected,
                    Duration = 3
                })
            end
        })
