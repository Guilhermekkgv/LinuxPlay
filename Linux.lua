                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        ...
                        local OptBtn = Linux.Instance("TextButton", {
                            Parent = OptionsHolder,
                            BackgroundColor3 = isSelected and Color3.fromRGB(30, 30, 35) or Color3.fromRGB(23, 23, 23),
                            BorderColor3 = Color3.fromRGB(40, 40, 50),
                            BorderSizePixel = 0,
                        ...
                        OptBtn.MouseEnter:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(28, 28, 28)}):Play()
                            end
                        end)
                        
                        OptBtn.MouseLeave:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(23, 23, 23)}):Play()
                            end
                        end)
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            if IsMulti then
                                ...
                                if index then
                                    ...
                                    OptBtn.BackgroundColor3 = Color3.fromRGB(23, 23, 23)
                                else
